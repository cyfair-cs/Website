 ...
 */
 function load_announcements() {
    const ancments_db = [
        ...
        new Announcement('2021 District Competition', 'Depicted in the photo, you can see our 2021 district runner-up UIL Computer Science team! On the far left is our former president, Gavin Joyce, who placed 5th Individually, in the middle you can see our current president, Carson Stark, and on the right is the VP, Steven Nguyen, who placed 4th individually.', '../res/img/2021comp.png', '2021 District Competition')
    ];
